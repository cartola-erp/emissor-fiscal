...
SELECT * FROM  trib_esta WHERE ncm_id IN ( 
	SELECT ncm_id FROM ncms WHERE nume IN (73181500, 73181600, 76161000, 73182400, 84814000, 84818099, 73182300, 73182200, 39269090, 76169900, 74152900, 73269090, 39100012, 38249941 )
) and oper_id = 1 ;
...
-- 1 - VENDA
SELECT * FROM trib_esta WHERE ncm_id IN ( 
	SELECT ncm_id FROM ncms WHERE nume IN (87089100, 40103200, 84137080)
) and oper_id = 1 ;
...
UPDATE trib_esta t 
		...
		t.cfop = 5656 
WHERE t.ncm_id IN ( 
	SELECT ncm_id FROM ncms WHERE nume IN(27101931, 27101932, 27101992, 27129000, 34031900, 38112190, 27101991, 34039900 )
) and t.oper_id = 1;
...
UPDATE trib_esta SET cod_anp = 620501001 WHERE ncm_id IN (SELECT ncm_id FROM ncms WHERE nume IN(34039900));
