...
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5101, 1556, 5556, "COMERCIALIZACAO", "NORMAL", "", 23);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5102, 1556, 5556, "COMERCIALIZACAO", "NORMAL", "", 23);
...
-- ICMS_CST == null -> Deverá ser usado a mesma que vier na NF do fornecedor							
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5101, 1556, 5556, "COMERCIALIZACAO", "NORMAL", "", 28);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5102, 1556, 5556, "COMERCIALIZACAO", "NORMAL", "", 28);
-- as cst acima devem ser "null" ! ? (Ou alguma outra forma que indique que eu tenha que pegar a do fornecedor )

-- Destacamos o ICMS na Devolução (Veio na compra mas não podemos nos creditar)
-- Verificar se nessas cfop abaixo (5401, 5402 e 5403 temos que mencionar o ICMS na devolução, caso sim acredito que o ICMS CST tenha que ser != 90)
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5401, 1407, 5413, "COMERCIALIZACAO", "NORMAL", "", 28);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5402, 1407, 5413, "COMERCIALIZACAO", "NORMAL", "", 28);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5403, 1407, 5413, "COMERCIALIZACAO", "NORMAL", "", 28);
					
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5405, 1407, 5413, "COMERCIALIZACAO", "NORMAL", "", 28);					
-- Óleo
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5652, 1653, 5662, "COMERCIALIZACAO", "NORMAL", "", 28);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5655, 1653, 5662, "COMERCIALIZACAO", "NORMAL", "", 28);
INSERT INTO trib_esta_devo (icms_cst, cfop_venda, cfop_entr, cfop_nota_devo, finalidade, regime_tributario , mens, oper_id) 
					VALUES	(90, 5656, 1653, 5662, "COMERCIALIZACAO", "NORMAL", "", 28);
-- ==================================================================================================================================		