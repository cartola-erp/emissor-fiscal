...
UPDATE trib_esta t 
		...
		t.cfop = 5656 
WHERE t.ncm_id IN ( 
	SELECT ncm_id FROM ncms WHERE nume IN(27101931, 27101932, 27101992, 27129000, 34031900, 38112190, 27101991, 84133030 )
) and t.oper_id = 1;
...
UPDATE trib_esta SET cod_anp = 650101001 WHERE ncm_id IN (SELECT ncm_id FROM ncms WHERE nume IN(84133030));
