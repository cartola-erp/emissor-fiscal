...
@Service
public class AmqpNfceService implements AmqpDocumentoFiscalServiceInterface {
    ...
    @Override
    @RabbitListener(queues = AmqpDocumentosFiscaisDestinos.NFCE.QUEUE_NFCE_EMISSAO_REQUISICAO_NAME)
    ...
    public void enviarRespostaRequisicaoEmissao(InvoiceResponse invoiceModel) {
        ...
        amqpSenderService.sendMessage(
                ...
                AmqpDocumentosFiscaisDestinos.NFCE.ROUTING_KEY_NFCE_EMISSAO_RESPOSTA,
                jsonResponse
        );
    }
