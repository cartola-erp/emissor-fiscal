...
DROP PROCEDURE IF EXISTS `PR_CADASTRA_TRIBUTACOES_FEDERAIS_MONO`;

DELIMITER $$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PR_CADASTRA_TRIBUTACOES_FEDERAIS_MONO`() 
BEGIN
...
CALL PR_CADASTRA_TRIBUTACOES_FEDERAIS_MONO();
